...
export const multiLanguageCommandsText = () => ({
  ...
  ru: {
    ...
    \nДля поиска и выдачи совместных игр нужно, чтобы было добавленно минимум два игрока в список отслеживаемых. Бот принимает только корректно написаные никнеймы пользователей FaceIt.`,
  },
});
